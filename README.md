...
- **[humanizer-ru](./skills/productivity/humanizer-ru/SKILL.md)** — Edit Russian prose until it stops reading as AI-generated: audit against 38 slop patterns, fix only what the audit found, then close on a deterministic linter. Also runs detect-only, returning a verdict with quoted evidence and changing nothing.
